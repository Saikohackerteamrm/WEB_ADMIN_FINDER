...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/WEB_ADMIN_FINDER/blob/main/20250805_163155.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/WEB_ADMIN_FINDER
    $ cd  WEB_ADMIN_FINDER
    $ bash Mithila.sh
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/WEB_ADMIN_FINDER && cd WEB_ADMIN_FINDER && bash Mithila.sh
 ### Hi there 👋
